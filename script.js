...
const firstButton = document.getElementById("page-1");
const secondButton = document.getElementById("page-2");
const thirdButton = document.getElementById("page-3");
...
function displayContent(page) {
    contentContainer.textContent = jsonData[page].name;
}

function updatePaginationButtons() {
    prevButton.disabled = currentPage === 0;
    nextButton.disabled = currentPage === jsonData.length - 1;
}
...
nextButton.addEventListener("click", () => {
    if (currentPage < jsonData.length - 1) {
        currentPage++;
        displayContent(currentPage);
        updatePaginationButtons();
    }
